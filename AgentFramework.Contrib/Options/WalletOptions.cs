...
namespace AgentFramework.Contrib.Options
{
    /// <summary>Wallet options</summary>
    public class WalletOptions
    {
        /// <summary>Initializes a new instance of the <see cref="WalletOptions"/> class.</summary>
        ...
        /// <summary>Gets or sets the wallet configuration.</summary>
        ...
        /// <summary>Gets or sets the wallet credentials.</summary>
